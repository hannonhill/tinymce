  ...
  grunt.initConfig({
    ...
    "bolt-build": {
      "plugin": {
        ...
        output_dir: "scratch",
        main: "tinymce.plugins.embeddedblocks.Plugin",
        filename: "plugin",
        ...
        files: [
          {
            ...
            dest: "dist/embeddedblocks/plugin.js"
          },
          {
            src: "src/main/css/embeddedblocks.css",
            dest: "dist/embeddedblocks/css/embeddedblocks.css"
          }
        ]
      }
    },
        ...
        files: [
          {
            ...
            dest: "dist/embeddedblocks/plugin.min.js"
          }
        ]
      }
    }
